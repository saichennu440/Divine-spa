    ...
    <div className="pt-20">
      <section className="py-20 bg-gradient-to-b from-cream to-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <AnimatedSection>
            <h1 className="text-5xl md:text-6xl font-montserrat font-light text-gray-900 mb-6">Terms & Conditions</h1>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat font-semibold">1. Booking & Cancellation</h2>
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat font-semibold">2. Health & Consent</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat font-semibold">3. Pricing & Payments</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat font-semibold">4. Liability's</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat font-semibold">5. Code of Conduct</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat font-semibold">6. Intellectual Property</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat font-semibold">7. Governing Law</h2>
            <p className="text-gray-600 mt-2">
