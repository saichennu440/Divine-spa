    ...
    <div className="pt-20">
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">1. Booking & Cancellation</h2>
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">2. Health & Consent</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">3. Pricing & Payments</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">4. Liability's</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">5. Code of Conduct</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">6. Intellectual Property</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">7. Governing Law</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">Contact</h2>
            <p className="text-gray-600 mt-2">
