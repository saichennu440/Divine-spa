    ...
    <div className="pt-20">
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 space-y-8">
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat">1. Information We Collect</h2>
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">2. How We Use Your Information</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">3. Sharing & Third Parties</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">4. Security</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">5. Your Rights</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">6. Cookies & Analytics</h2>
            <p className="text-gray-600 mt-2">
          ...
          <AnimatedSection>
            <h2 className="text-2xl font-montserrat ">7. Changes to this Policy</h2>
            <p className="text-gray-600 mt-2">
