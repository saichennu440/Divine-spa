...
const FootPedicure: React.FC = () => {
  ...
  const ServiceCard: React.FC<{ item: ServiceItem }> = ({ item }) => {
    ...
    // split name into main and parenthetical part e.g. "Facial Clean-up (Watermelon / Strawberry)"
        ...
        <div className="p-8 flex flex-col flex-grow">
          ...
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-2xl font-montserrat font-semibold text-gray-900">
              {mainTitle}
              {parenthesis && <span className="block text-sm font-montserrat text-gray-600 mt-1">({parenthesis})</span>}
            </h3>
      ...
      <section className="py-10 bg-gradient-to-b from-cream to-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <AnimatedSection>
            ...
            <h1 className="text-5xl md:text-6xl font-montserrat font-light text-gray-900 mb-4">Foot Pedicure</h1>
